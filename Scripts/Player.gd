...
# Sets States for Crouching
		...
		sprinting = false
		crouching = true
# Ensuring sliding only occurs when pressed
	...
	#  Handles Sprinting States and speed
		if Input.is_action_pressed("sprint"):
			...
			sprinting = true
			crouching = false
#  Handles Walking States and speed
		else:
...
# Function for dash timer and alters dashing state variable
...
# Gives player hit response from enemy
func hit(dir):
